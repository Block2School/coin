...
contract NFTMarketplace is ERC721URIStorage {
    ...
    constructor() ERC721("B2S Tokens", "B2SNFT") {
        ...
        returns (uint256)
    {
        ...
        createMarketItem(newTokenId, price, name, tokenURI);
        return newTokenId;
    }

    function createMarketItem(uint256 tokenId, uint256 price, string memory name, string memory tokenURI) private {
